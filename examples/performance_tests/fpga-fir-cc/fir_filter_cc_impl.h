...
#ifndef INCLUDED_ZYNQ_FIR_FILTER_CC_IMPL_H
#define INCLUDED_ZYNQ_FIR_FILTER_CC_IMPL_H
...
namespace gr {
  namespace zynq {
    ...
    class fir_filter_cc_impl : public fir_filter_cc
    {
     private:
      int d_fd;
     ...
     public:
      fir_filter_cc_impl(const std::vector<int> &taps);
      ~fir_filter_cc_impl();
...
#endif /* INCLUDED_ZYNQ_FIR_FILTER_CC_IMPL_H */
